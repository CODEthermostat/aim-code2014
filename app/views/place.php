...
<html>
        ...
        <body>
                ...
                <div class="searchbar" style="text-align:center;">
                        ...
                        <form class="well form-search" style="font-family:'Roboto', sans-serif;">

                             <input type="text" class="span3 search-query" style="font-size:14px" placeholder="city's name..."/></br></br>
